...
import { push, ref, get, orderByChild, query, equalTo, child, onValue, set, remove, update } from 'firebase/database';
...
export const useUserOperations = () => {
    ...
    async function checkUserEmailExists(email) {
        const usersRef = ref(database, 'users');
        const usersQuery = query(usersRef, orderByChild('userEmail'), equalTo(email));
